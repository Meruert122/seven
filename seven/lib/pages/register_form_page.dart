...
import 'package:seven/generated/locale_keys.g.dart';
        ...
        child: ListView(
          ...
          children: [
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: GestureDetector(
                  ...
                  child: const Icon(
                    ...
                    color: Color.fromARGB(255, 159, 23, 14),
                  ),
                ),
                ...
                focusedBorder: const OutlineInputBorder(
                  borderRadius: BorderRadius.all(Radius.circular(20.0)),
                  borderSide: BorderSide(color: Color.fromARGB(255, 18, 70, 112), width: 2.0),
                ),
              ),
            ...
            ElevatedButton(
              ...
              child: const Text('RU'),
              style: ElevatedButton.styleFrom(
                primary: Color.fromARGB(255, 18, 70, 112), // это основной цвет кнопки
                onPrimary: Colors.white, // это цвет текста и иконки на кнопке
                  ),
            ),
            ElevatedButton(
              onPressed: ()async{
  ...
  void _showMessage({required String message}) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: Color.fromARGB(255, 159, 23, 14),
        content: Text(
          message,
